...
@section('content')
  @if(count($errors) > 0)
    <div id="msg" class="alert alert-danger">
      ...
      @endif
      <div class="container">
        <section id="uploadSection" class="row justify-content-center">
          <div class="col-md-8">
            <article id= "createCard" class="card">
              <div class="card-header">{{ __('Subir una App') }}</div>

              <div class="card-body">
                <form method="POST" action="{{ route('uploadPost', $application["application_id"]) }}">
                  {{ method_field('PATCH') }}
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="name" value="{{ $application["name"] }}" required autocomplete="nombre" autofocus>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input type="textarea" class="md-textarea form-control" name="description" value="{{ $application['description'] }}" required>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div id="image" class="col-md-6 offset-md-4">
                                <input class="form-control" type="url" name="image_url" value="{{ $application['image_url'] }}" > <br>
                              </div>
                            </div>
                            <div class="form-group row">
                              <label id="catInCreate" for="category">Elija la categoría correspondiente: </label>
                              <select name="category_id" id="catInCreate" class="mdb-select md-form" value="{{ $application['category'] }}">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-6 offset-md-4">
                                <input id="price" class="form-control" type="number" name="price" value="{{ $application['price'] }}" required>
                              </div>
                            </div>
